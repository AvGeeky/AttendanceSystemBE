package com.appbuildersinc.attendance.source.functions.Miscallaneous;
...
public class FunctionsMisc {
    ...
    @Autowired
    public FunctionsMisc(FacultyDB userdb, FacultyJwtUtil jwtutil, emailUtil emailutil, KeyPairUtil keyutil, SuperAdminDB admindb, SuperAdminjwtUtil adminjwtclass) {
        this.userdb = userdb;
